...
class SharedState:
    ...
    def get_status(self):
        ...
        return {
            ...
            "low_voltage": info.get("low_voltage", False),
            ...
            "ir_middle": (self.autonomous.get_ir_values()[1] if self.autonomous else None),
            "ir_right":  (self.autonomous.get_ir_values()[2] if self.autonomous else None),
