...
METADATA = {
    ...
    "ultrasonic.py": {
        "name": "Ultrasonic Distance (DISABLED)",
        "name_ru": "Ультразвук (ОТКЛЮЧЕН)",
        "desc": "HC-SR04 not present — module disabled",
        "desc_ru": "HC-SR04 отсутствует — модуль отключён",
        "icon": "⚠️",
        "hardware": ["Ultrasonic"],
    },
    "line_track.py": {
        "name": "Line Tracking (DISABLED)",
        "name_ru": "Датчик линии (ОТКЛЮЧЕН)",
        "desc": "IR line tracker not present — module disabled",
        "desc_ru": "ИК датчик линии отсутствует — модуль отключён",
        "icon": "⚠️",
